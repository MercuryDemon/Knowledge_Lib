...
Слайс основан на каком-то базовом массиве определенной длины. Слайс указывает на начало массива. Длина от начала слайса до конца базового массива определяет капасити(ёмкость) слайса.  Длина слайса это количесво элементов от начала слайса до конца.
