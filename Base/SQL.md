...
ограничение - constraint - ограничивают некоторые изменения в базе для того, чтобы она оставалась в согласованном состоянии
...
не пустые значения, содержатьстолбец должен
