...
Интерфейсы следует располагать в месте их использования, для того чтобы:
- уменьшить связность системы(можно изменять одни элементы, зная что другие не придется изменять в последствии)
- Делает интерфейсы минималистичными
- делает интиерфейсы независимыми от реализации
