...
Обычно константная операция O(1), прибавляем к отсчитываем от начала массива адрес конца массива (прибавляем size) и записываем.
...
Сложность всё равно линейная O(n).
