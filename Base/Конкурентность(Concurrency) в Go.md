...
Done - декркментирует счётчик (на единицу если верить исходникам пакета=) )
...
когда в горутинах используются передача данных по канала и они становятся воркерами.
...
Fun-out - распределение данных из одного входного канала между несколькими горутинами-обработчиками.
