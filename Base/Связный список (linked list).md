...
Это как массив, только в массиве[[Массив (array)]] данные хранятся в памяти последовательно, а в связанном списке они находятся в разных частях памяти звеньями. 
